...
docker-compose exec --user=1000:1000 web sh -c "composer require drupal/console:~1.0 drush/drush drupal/admin_toolbar drupal/twig_tweak:^2.5 drupal/field_group:^3.0 drupal/pathauto:^1.6 drupal/paragraphs:^1.11"
docker-compose exec --user=1000:1000 web sh -c 'vendor/bin/drush si standard --db-url=mysql://root:123@db/drupal8 -y'
docker-compose exec --user=1000:1000 web sh -c 'yes | vendor/bin/drush en admin_toolbar twig_tweak field_group pathauto paragraphs'
